...
public class SmallBedroomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.small_bedroom_activity);
        TAG = "Message";

        mDatabase = FirebaseDatabase.getInstance().getReference();

        light = (Switch) findViewById(R.id.small_bedroom_light);
        fan = (Switch) findViewById(R.id.small_bedroom_fan);
        fanSpeed = (SeekBar) findViewById(R.id.small_bedroom_fan_speed);
        timerLight = new Chronometer(this);
        timerFan = new Chronometer(this);

        fanSpeed.setEnabled(false);

        mDatabase.child("SMALL BEDROOM").child("LIGHT").setValue(false);
        mDatabase.child("SMALL BEDROOM").child("FAN").setValue(false);
        mDatabase.child("SMALL BEDROOM").child("SPEED").setValue(0);
        ...
        light.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked == true){
                    Log.d(TAG,"Small bedroom light is off, turning it on");
                    mDatabase.child("SMALL BEDROOM").child("LIGHT").setValue(true);
                    timerLight.setBase(System.currentTimeMillis());
                    timerLight.start();
                }

                else{
                    Log.d(TAG,"Small bedroom light is on, turning it off");
                    mDatabase.child("SMALL BEDROOM").child("LIGHT").setValue(false);
                    timerLight.stop();
        ...
        fan.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked == true){
                    ...
                    Log.d(TAG,"Small bedroom fan is off, turning it on");
                    mDatabase.child("SMALL BEDROOM").child("FAN").setValue(true);
                    ...
                    fanSpeed.setEnabled(false);
                    Log.d(TAG,"Small Bedroom fan is on, turning it off");
                    mDatabase.child("SMALL BEDROOM").child("FAN").setValue(false);
                    timerFan.stop();
        ...
        fanSpeed.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mDatabase.child("SMALL BEDROOM").child("SPEED").setValue(progress);
            }
